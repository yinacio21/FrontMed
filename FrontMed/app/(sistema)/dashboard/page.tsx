...
export default function DashboardPage() {
  ...
  const nome = dash.medicoNome || usuario?.nome || "Médico";
    ...
    <div className="ms-page-shell space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Aqui está o resumo da sua clínica hoje.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
        {[
          ...
          { label: "Últimos registros", value: dash.carregado ? String(dash.ultimosProntuarios.length) : "—", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z", color: "text-teal-700 bg-teal-50" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 ms-card overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
            <h3 className="font-semibold text-slate-800 text-sm">Últimos Prontuários</h3>
          ...
          {!dash.carregado ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 gap-3 text-center">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-600">Nenhum prontuário ainda</p>
                  ...
                  <div key={p.id} className={"flex items-center gap-4 px-6 py-4 transition-colors " + (urgente ? "bg-amber-50/60" : "hover:bg-slate-50")}>
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      ...
                      <button
                        ...
                        title={urgente ? "Remover urgência" : "Marcar como urgente"}
        ...
        <div className="space-y-4">
          ...
          <div className="ms-card overflow-hidden">
            ...
            {urgentes.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-8 gap-2 text-center px-4">
                ...
                <p className="text-xs text-slate-400">Clique no sino de um prontuário para marcar.</p>
              </div>
            ) : (
          ...
          <div className="ms-card p-5">
            <h3 className="font-semibold text-slate-800 text-sm mb-4">Atalhos Rápidos</h3>
            <div className="space-y-2">
              {[
                ...
                { href: "/medicos", label: "Gestão de Médicos", desc: "Contas do sistema", color: "bg-violet-600", icon: "M4.8 2.3A.3.3 0 1 0 5 2H4a2 2 0 0 0-2 2v5a6 6 0 0 0 6 6M8 15v1a6 6 0 0 0 6 6M20 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4" },
              ].map(a => (
          ...
          <div className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 p-5 shadow-[0_14px_34px_rgba(15,118,110,0.08)]">
            <div className="flex items-center gap-2.5 mb-2">
              ...
              <p className="text-sm font-bold text-emerald-800">Proteção ativa</p>
            </div>
            <p className="text-xs text-emerald-700 leading-relaxed">Seus dados clínicos estão protegidos com acesso exclusivo por médico autenticado.</p>
          </div>
        </div>
      </div>
    </div>
